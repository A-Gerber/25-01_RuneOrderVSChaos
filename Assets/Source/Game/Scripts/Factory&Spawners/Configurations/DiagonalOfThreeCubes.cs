internal class DiagonalOfThreeCubes : CubesConfiguration
{
...
internal class DiagonalOfFourCubes : CubesConfiguration
{
    private const bool IsUseCoefficients = true;
    private const bool IsTransposing = true;
