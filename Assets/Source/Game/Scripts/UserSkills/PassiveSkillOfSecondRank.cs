...
{
    private const string SkillName = "SecondPassiveSkill";
    private readonly int _comboManaReward = 50;
    private readonly int _damagePerProjectile = 1;
    private readonly int _comboSkillPointsInterval = 7;
    private readonly float _timeFrameOfCombo = 5f;

    private string _description;

    public PassiveSkillOfSecondRank(Sprite iconOnButton, ParticleSystem effect, AudioClip audioClip, int manaCost) : base(iconOnButton, effect, audioClip, manaCost)
    {    }
