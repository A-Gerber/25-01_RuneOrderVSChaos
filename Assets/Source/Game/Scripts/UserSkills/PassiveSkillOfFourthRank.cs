...
{
    private const string SkillName = "FourthPassiveSkill";
    private readonly int _comboManaReward = 70;
    ...
    public PassiveSkillOfFourthRank(Sprite iconOnButton, ParticleSystem effect, AudioClip audioClip, int manaCost) : base(iconOnButton, effect, audioClip, manaCost)
    {    }
