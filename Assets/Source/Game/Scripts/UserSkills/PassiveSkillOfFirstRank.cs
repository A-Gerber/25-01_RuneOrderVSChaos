...
{
    private const string SkillName = "FirstPassiveSkill";
    private readonly int _comboManaReward = 40;
    ...
    public PassiveSkillOfFirstRank(Sprite iconOnButton, ParticleSystem effect, AudioClip audioClip, int manaCost) : base(iconOnButton, effect, audioClip, manaCost)
    {    }
