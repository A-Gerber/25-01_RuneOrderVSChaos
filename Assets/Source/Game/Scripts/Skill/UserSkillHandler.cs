...
internal class UserSkillHandler : IAddableSkill, IChangeableLevel
{
    ...
    private IConfigurableFromSkillSide _attacker;
    private IPassiveSkill _firstPassiveSkill;
    private readonly int _skillPointsInterval;
    private int _level;
    private int _score;

    public UserSkillHandler(SkillCardDiscoverer skillCardDiscoverer, int skillPointsInterval, IConfigurableFromSkillSide attacker, IPassiveSkill firstPassiveSkill)
    {
        ...
        _skillPointsInterval = skillPointsInterval;
