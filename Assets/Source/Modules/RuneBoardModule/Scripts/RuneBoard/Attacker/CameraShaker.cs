...
{
    private readonly float _perlinNoiseTimeScale = 1f;
    private readonly float _shakeTimerValue = 1f;
    private readonly Transform _cameraTransform;
    private readonly AnimationCurve _perlinNoiseAmplitudeCurve;
    ...
    {
        _cameraTransform = cameraTransform != null ? cameraTransform : throw new InvalidOperationException("cameraTransform is null");
