...
internal class WinGameScreen : Window
{
    ...
    [SerializeField] private TextMeshProUGUI _textManaCountIncrease;
    ...
    internal void UpdateIncreases(int gameScoreIncrease, int currentLevel, int manaCountIncrease)
    {
        ...
        _textManaCountIncrease.text = $"+{manaCountIncrease}";
