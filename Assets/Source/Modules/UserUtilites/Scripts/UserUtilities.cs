...
public static class UserUtilities
{
    ...
    public static LocalPosition TranslateInLocalPosition(Vector3 position)
    {
        return new LocalPosition((int)position.x, (int)position.z);
    }

    public static Vector3 TranslateInVector3(LocalPosition position)
    {
